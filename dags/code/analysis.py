...
df = pd.read_csv(f'/home/athoillah/Documents/Local_Twitter_Pipeline/output/twitter_data_original.csv')
...
df.to_csv(f'/home/athoillah/Documents/Local_Twitter_Pipeline/output/twitter_data.csv', index=False)
